...
from eeg_filereader import LiveArousalClassifier, LiveEEGStreamFeeder, OfflineEEGFeeder
...
def main():
    ...
    while window.running:
        ...
        print(f"state: {state}, ratio : {ratio}")

        # ---- GUI ----
        """ # remove when recording screen for testing
